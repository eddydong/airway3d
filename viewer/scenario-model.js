...
export function buildReport(base,settings,plans,q,meta={}) {
  ...
  return {version:MODEL_VERSION,generatedAt:new Date().toISOString(),q,scanPosition:'supine',
    ...
    limitations:[
      ...
      'Posture is a static four-position assumption. A fixed response factor is retained from the reference metadata for compatibility with recorded CFD. Response amplitudes, cycle bias and suppression are not inferred from CT or validated for this patient.',
