...
export const RECORDED_CFD_NOTE_TRANSIENT = 'Numbers and particles follow a recorded 3-D velocity in every cell. This is playback of an offline solve, not a live solver. Choose a complete saved scenario; its anatomy and breathing settings stay matched.';
...
export const CFD_GEOMETRY_NOTE = 'The selected saved scenario supplies the exact airway and breathing settings used by its CFD solve. Region labels and tissue response are assumptions.';
